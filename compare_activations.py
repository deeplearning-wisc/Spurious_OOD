...
print('activation shape', ida.shape)
...
plt.plot(range(n), idasort, 'o', ms=0.5, label='ID')
plt.show()
plt.savefig('activations/plotID.png') # , 'o')

plt.plot(range(n), hnasort, 'o', ms=1, label='NSP')
plt.show()
plt.savefig('activations/plotNSP.png') # , 'o')

plt.plot(range(n), waasort, 'o', ms=1, label='SP')
plt.show()
plt.legend(loc="upper left")
plt.savefig('activations/plotSP.png') # , 'o')
